...
class DiscriminatorR(nn.Module):
    ...
    def setup(self):
        ...
        self.convs = [
            nn.Conv( 32, (3, 9),kernel_init=nn.initializers.normal()),
            nn.Conv( 32, (3, 9), strides=(1, 2),kernel_init=nn.initializers.normal()),
            nn.Conv( 32, (3, 9), strides=(1, 2),kernel_init=nn.initializers.normal()),
            nn.Conv( 32, (3, 9), strides=(1, 2),kernel_init=nn.initializers.normal()),
            nn.Conv( 32, (3, 3),kernel_init=nn.initializers.normal()),
        ]
        self.conv_post = nn.Conv( 1, (3, 3),kernel_init=nn.initializers.normal())
